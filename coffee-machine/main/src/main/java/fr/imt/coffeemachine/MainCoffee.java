...
import fr.imt.coffeemachine.storage.container.Mug;
import fr.imt.coffeemachine.storage.exception.CupNotEmptyException;
import fr.imt.coffeemachine.storage.exception.ExceptionContainerCreation;
...
public class MainCoffee {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //Risque d'exploitation malveillante de la trace via une remontée directe dans la console/interface web.
            //e.printStackTrace();
